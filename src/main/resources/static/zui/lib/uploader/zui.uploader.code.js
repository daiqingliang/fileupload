			...
			function f() {
				...
				e.extend(this, S, {
					...
					open: function(o, s, a, l, u) {
						...
						if (s = n.utf8_encode(s), c = r.parseUrl(s), z = r.hasSameOrigin(c), v = r.resolveUrl(s), (l || u) && !z) throw new t.DOMException(t.DOMException.INVALID_ACCESS_ERR);
						if (y = l || c.user, E = u || c.pass, T = a || !0, T === !1 && (i("timeout") || i("withCredentials") || "" !== i("responseType"))) throw new t.DOMException(t.DOMException.INVALID_ACCESS_ERR);
					...
					send: function(i, r) {
						...
						this.withCredentials || (this.withCredentials = B.required_caps && B.required_caps.send_browser_cookies && !z), N = !F && this.upload.hasEventListener(), L = !1, M = !i, F || (C = !0), l.call(this, i)
					},
					abort: function() {
			...
			function r(o) {
				function s(i, r) {
					...
					for (o = h.SHORT(i), s = 0; o > s; s++) if (g = [], f = i + 2 + 12 * s, a = r[h.SHORT(f)], a !== t) {
						if (l = x[h.SHORT(f += 2)], u = h.LONG(f += 2), p = y[l], !p) throw new n.ImageError(n.ImageError.INVALID_META_ERR);
			...
			function u() {
				...
				function p(e) {
					...
					g = new Image, g.onerror = function() {
						...
						t.trigger("load")
					}, g.src = "data:" == e.substr(0, 5) ? e : d(e, E.type)
				}
				...
				function h() {
					v && (v.purge(), v = null), y = g = x = E = null, b = !1
				}
				var g, v, x, y, E, w = this,
					b = !1,
					_ = !0;
				t.extend(this, {
					loadFromBlob: function(e) {
						...
						return E = e, e.isDetached() ? (y = e.getSource(), void p.call(this, y)) : void f.call(this, e.getSource(), function(e) {
							r && (y = c(e)), p.call(t, e)
						})
					},
					loadFromImage: function(e, t) {
						this.meta = e.meta, E = new o(null, {
							name: e.name,
							size: e.size,
							type: e.type
					...
					getInfo: function() {
						...
						return !v && y && i.can("access_image_binary") && (v = new s(y)), t = {
							width: e().width || 0,
							height: e().height || 0,
							type: E.type || l.getFileMime(E.name),
					...
					getAsBinaryString: function(e, t) {
						...
						if ("image/jpeg" !== e) y = c(w.getAsDataURL(e, t));
						else {
							var i;
							t || (t = 90), u();
							try {
							...
							y = c(i), v && (y = v.stripHeaders(y), _ && (v.meta && v.meta.exif && v.setExif({
...
function(e, t) {
	...
	function(e, t, i) {
		...
		l.addFileFilter("mime_types", function(e, t, i) {
			...
			function f() {
				...
				}), this.bind("CancelUpload", w), this.bind("BeforeUpload", v), this.bind("UploadFile", x), this.bind("UploadProgress", y), this.bind("StateChanged", E), this.bind("QueueChanged", c), this.bind("Error", _), this.bind("FileUploaded", b), this.bind("Destroy", R)
			}
	...
	var c = {
		...
		d = function(n, l) {
			var u = this;
			u.name = s, u.$ = e(n).addClass("uploader"), l = u.getOptions(l);
			...
			if (!h) {
				...
				g.length && (h = g.first().clone().removeClass("template"), g.remove()), h || (h = a)
			}
			...
			var y = l.drop_element,
				E = ("fileList" == y ? u.$list : "self" == y ? u.$ : e(y)).first().addClass("file-drag-area");
			if (o) E.attr("data-drop-placeholder", "");
			else {
				var w = l.dropPlaceholder;
				w === !0 && (w = c.dropPlaceholder), w && E.attr("data-drop-placeholder", w)
			}
			u.$dropElement = E, u.$message = f.find(".uploader-message").on("click", ".close", function() {
				u.hideMessage()
			}), u.$status = f.find(".uploader-status"), f.toggleClass("uploader-rename", !! l.rename), u.initPlupload(), f.on("click." + s, ".uploader-btn-start", function(e) {
				u.start()
			}).on("click." + s, ".uploader-btn-browse", function(t) {
				e(this).is(u.$button) || u.$button.trigger("click")
			}).on("click." + s, ".uploader-btn-stop", function(e) {
				u.stop()
			}), e("body").on("dragleave." + s + " drop." + s, function(e) {
				f.removeClass("file-dragable"), e.preventDefault(), e.stopPropagation()
			}).on("dragover." + s + " dragenter." + s, function(e) {
				f.addClass("file-dragable")
			}), E.on("dragleave." + s + " drop." + s, function(e) {
				f.removeClass("file-drag-enter")
			}).on("dragover." + s + " dragenter." + s, function(e) {
				f.addClass("file-drag-enter")
			}), p.on("click." + s, ".btn-delete-file", function() {
			...
			}).on("click." + s, ".btn-reset-file", function() {
			...
			}), l.rename && (p.toggleClass("file-rename-by-click", !! l.renameByClick).toggleClass("file-show-rename-action-on-done", !! l.renameActionOnDone), p.on("click." + s, ".btn-rename-file" + (l.renameByClick ? ",.file-name" : ""), function() {
				var t = e(this).closest(".file");
				if (!t.hasClass("file-renaming")) {
					var n = u.plupload.getFile(t.data("id")) || t.data("file"),
						o = l.renameActionOnDone,
						a = n.status === i.DONE && e.isFunction(o);
					if (a || n.status === i.QUEUED) {
						...
						t.addClass("file-renaming"), u.showFile(n), !l.renameExtension && n.ext && c.text(n.name.substr(0, n.name.length - n.ext.length - 1)), c.attr("contenteditable", "true").one("blur", function() {
							...
							t.removeClass("file-renaming"), c.off("keydown." + s).attr("contenteditable", null)
	...
	d.DEFAULTS = l, d.prototype.showMessage = function(e, t, i) {
		...
		var t = this,
			i = "." + s;
		t.$.off(i).data(s, null), t.$list.off(i), t.$dropElement.off(i), e("body").off(i), t.plupload.destroy()
		...
		if ("string" == typeof t && (t = r.plupload.getFile(t)), t) {
			...
			if (o && o.length) {
				...
				if (s.fileFormater) s.fileFormater.call(r, o, t, a);
					...
					c.find(".text").text("uploading" == a ? t.percent + "%" : "failed" == a ? r.lang[a] : ""), e.fn.tooltip && o.find('[data-toggle="tooltip"]').tooltip("fixTitle"), o.find("a.btn-download-file, a.file-name").attr("href", l)
				}
		...
		if (t.options.statusCreator) a = t.options.statusCreator(s, o, t);
			...
			var u = {
				...
				size: i.formatSize(s.size + t.staticFilesSize).toUpperCase(),
				queue: s.queued,
				failed: s.failed,
				uploaded: s.uploaded,
			...
			a = {
						...
						if (e.isFunction(c)) d = c.call(n, a, s);
							...
							if (e.isPlainObject(p)) {
								...
								f !== r && "ok" !== f && "success" !== f && 200 !== f && (d = {
									message: p.message,
									data: p
								}), p.id !== r && (s.remoteId = p.id), p.url !== r && (s.url = p.url), p.name !== r && (s.name = p.name)
							}
						}
						if (d) return d = e.isPlainObject(d) ? d : {
							message: d
						}, s.status = i.FAILED, d.code === r && (d.code = i.GENERIC_ERROR), d.file = s, d.responseObject = a, t.trigger("Error", d), void(s.errorMessage = d.message)
					}
				...
				UploadComplete: function(t, r) {
					...
					if (s) {
						...
						c += "string" == typeof s ? s.format(d) : e.isFunction(s) ? s(d) : n.lang[l > 0 ? "uploadHasFailedMessage" : a > 0 ? "uploadSuccessMessage" : "uploadEmptyMessage"].format(d), n.showMessage(c, l > 0 ? "danger" : a > 0 ? "success" : "warning", 3)
					}
				...
				BeforeUpload: function(t, i) {
					var r = t.getOption("multipart_params"),
						s = o.multipart_params,
						a = {};
					r && r.key && (a.key = r.key), r && r.token && (a.token = r.token), o.sendFileName && (a[o.sendFileName === !0 ? "name" : o.sendFileName] = i.name), o.sendFileId && (a[o.sendFileId === !0 ? "uuid" : o.sendFileId] = i.id), a = e.extend(a, e.isFunction(s) ? s(i, a) : s), t.setOption("multipart_params", a), n.callEvent("onBeforeUpload", i)
				},
				Refresh: function(e) {
		...
		return this.each(function() {
			var n = e(this),
				r = n.data(s),
				o = "object" == typeof t && t;
			r || n.data(s, r = new d(this, o)), "string" == typeof t && r[t](i)
		})
	}, d.NAME = s, d.STATUS = u, d.ERRORS = c, d.NAME = s, d.LANG = {
		zh_cn: {
